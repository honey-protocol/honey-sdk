...
export declare type CacheReserveInfoStruct = CacheStruct & {
...
export declare type ReserveStateStruct = CacheStruct & {
    accruedUntil: BN;
    outstandingDebt: BN;
    uncollectedFees: BN;
    totalDeposits: BN;
...
export declare type WalletType = Wallet | MathWallet | SolongWallet | SlopeWallet | null;
export declare type NonNullWalletType = Wallet | MathWallet | SolongWallet | SlopeWallet;
...
export declare enum TxnResponse {
    Success = "SUCCESS",
    Failed = "FAILED",
    Cancelled = "CANCELLED"
}
