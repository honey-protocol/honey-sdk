...
export declare const MarketReserveInfoList: BL.Sequence;
export declare const ReserveStateLayout: BL.Structure;
export declare const PositionInfo: BL.Structure;
export declare const PositionInfoList: BL.Sequence;
