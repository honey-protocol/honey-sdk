...
class HoneyMarket {
    ...
    async createReserve(params) {
        ...
        const init_tx = await (0, web3_js_1.sendAndConfirmTransaction)(this.client.program.provider.connection, transaction, [this.client.program.provider.wallet.payer, account]);
